<?php
/**
 * Arquivo de configuração mínima do L5-Swagger.
 * Copie este arquivo para config/l5-swagger.php no seu projeto Laravel,
 * ou rode: php artisan vendor:publish --provider="L5Swagger\L5SwaggerServiceProvider"
...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => [
                'title' => 'Match Voluntários ↔ ONGs API',
            ],
