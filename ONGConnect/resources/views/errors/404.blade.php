...
<div class="min-h-[60vh] flex items-center justify-center px-6">
    <div class="text-center max-w-md">
        ...
        <h1 class="text-2xl font-bold tracking-tight text-ink mb-3">Página não encontrada</h1>
        <p class="text-ink-2 mb-8">O endereço que você acessou não existe ou foi removido.</p>
