...
<div class="min-h-[60vh] flex items-center justify-center px-6">
    <div class="text-center max-w-md">
        ...
        <h1 class="text-3xl font-bold tracking-tight text-ink mb-3">Acesso negado</h1>
        <p class="text-lg text-ink-2 mb-8">Você não tem permissão para acessar esta página.</p>
