        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                ...
                properties: [
                    ...
                    new OA\Property(property: 'evento_inicio', type: 'string', format: 'date-time', example: '2026-06-20 14:00'),
                    new OA\Property(property: 'evento_fim',    type: 'string', format: 'date-time', example: '2026-06-20 16:00'),
        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                ...
                properties: [
                    ...
                    new OA\Property(property: 'evento_inicio', type: 'string', format: 'date-time'),
                    new OA\Property(property: 'evento_fim',    type: 'string', format: 'date-time'),
